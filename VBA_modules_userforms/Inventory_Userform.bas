...
myValue = InputBox("Item: " & nome & vbCrLf & vbCrLf & "Código: " & it & vbCrLf & vbCrLf & "Enter the quantity of the item to be ADDED to the stock", "Inventory Receipt")
...
myValue = InputBox("Item: " & nome & vbCrLf & vbCrLf & "Cod: " & it & vbCrLf & vbCrLf & "Enter the quantity of the item to be PICKED UP in stock", "Inventory Issue")
...
Edit_Userform.Show vbModeless
Edit_Userform.codigo = it
